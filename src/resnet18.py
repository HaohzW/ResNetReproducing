...
class ResNet18(nn.Module):
    def __init__(self, class_number=10):
        ...
        self.downsample_23 = nn.Sequential(
        ...
        self.downsample_34 = nn.Sequential(
        ...
        self.downsample_45 = nn.Sequential(
    ...
    def forward(self, x):
        ...
        x += x_shortcut
        x = F.relu(x)
        x_shortcut = self.downsample_23(x)
        # conv3
        x = self.conv3_1(x)
        x += x_shortcut
        x = F.relu(x)
        ...
        x += x_shortcut
        x = F.relu(x)
        x_shortcut = self.downsample_34(x)
        # conv4
        x = self.conv4_1(x)
        x += x_shortcut
        x = F.relu(x)
        ...
        x += x_shortcut
        x = F.relu(x)
        x_shortcut = self.downsample_45(x)
        # conv5
        x = self.conv5_1(x)
        x += x_shortcut
        x = F.relu(x)
